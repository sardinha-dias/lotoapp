...
class LotofacilWidget extends StatefulWidget {
  const LotofacilWidget({Key? key}) : super(key: key);

  @override
  State<LotofacilWidget> createState() => _LotofacilWidgetState();
}

class _LotofacilWidgetState extends State<LotofacilWidget> {
